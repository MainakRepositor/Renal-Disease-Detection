...
def app():
    ...
    st.markdown('''<p style="font-size:23px; color:green; font-style:italic">Top Contacts Found</p>''',unsafe_allow_html=True)
    st.markdown('''<table>
                    <tr>
                    <th>Doctor Name</th>
                    <th>Contact</th>
                     ...
                     <td>+91-80561-00215</td>
                    </tr>
                    <tr>
                     <td>Dr. M Saravanan- MD, FRCS, Nephrology</td>
                     <td>+91-73388-22333</td>
                    </tr>
                    <tr>
                     <td>Dr. R Raja Mahesh, MD, MS, Nephrology</td>
                     <td>+91-1860-500-1066</td>
                    </tr>
