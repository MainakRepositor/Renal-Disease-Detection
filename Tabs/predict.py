...
def app(df, X, y):
    ...
    # Add a subheader
    st.sidebar.markdown('''<p style="background-color:yellow; color:black"> For BP > 125 : Renal problems induced by kidney malfunctioning <br> For Blood Urea > 200: High risk of bladder infection or kidney stone <br> For Haemoglobin > 13.5: High risk of kidney tumour <br> For Sodium Creatinine > 30 : Improper filteration <br> For Sugar level > 2.5 : Diabetic Renal<p>''', unsafe_allow_html = True)
